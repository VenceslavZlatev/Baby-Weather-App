...
class HourlyWeatherdays extends ConsumerWidget {
  const HourlyWeatherdays({Key? key}) : super(key: key);
      ...
      children: [
        Text(
          ...
          style: textTheme.caption!.copyWith(
              fontWeight: fontWeight, color: Colors.black, fontSize: 20.sp),
        ),
        SizedBox(height: 8.h),
        WeatherIconImage(iconUrl: data.findIconDay(), size: 120.h),
        SizedBox(height: 8.h),
        Text(
          '$temp°C',
